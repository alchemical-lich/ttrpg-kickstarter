...
The **market** grew, comfortably outpacing inflation. Total real dollars raised by funded RPG books roughly **tripled** between 2015 and 2025 — a real gain of about **220%**, far above the ~36% that the cost of living rose over the same stretch. But that is almost entirely *volume*: there are simply many more RPG-book campaigns now than a decade ago.

The **typical project**, by contrast, shrank. The median funded RPG book raised about **$10,800 in 2015 but only ~$4,400 in 2025** — already in constant dollars, a real fall of nearly **60%** — and the median per-backer pledge dropped from roughly **$56 to $29** in real terms. The median project and the median backer each put in about *half* what they did a decade ago, after inflation, and both sit well below the inflation line for the whole back half of the decade.
...
Is that just the cheap-zine wave dragging the median down? Partly, but not mostly. ZineQuest (from 2019) did pull in a flood of cheap zines, and dropping them lifts the median a little. But the fall barely needs them: among **non-zine** books the real per-backer pledge still dropped about **45%**, and within a fairly homogeneous slice — books that **name D&D 5e** — about **56%** (with the real raise down **62%**). Dropping the cheapest format doesn't rescue the trend, so the shrinking typical project isn't simply small projects entering.
...
So if even comparable books raise less per backer, did the **products themselves** get cheaper? Here the answer flips. Recovering the actual reward tiers from the archived campaign pages — the data behind the whale-tier section near the end of this post — I can follow the price of a *given* product over time, and those barely budge in real terms: the cheapest **digital/PDF** tier holds around **$25**, the standard **hardcover** around **$50**, and the **deluxe** edition around **$100**, all in constant 2025 dollars, none drifting down.[^deluxe] A hardback RPG book costs about what it always did, once you adjust for inflation.

![The real price of each product type holds flat](images/real_tier_ladder.png)

*Median price of the cheapest digital, hardcover, and deluxe tier per project, in constant 2025 dollars. Each product type is roughly flat across the decade — read the levels, not the year-to-year wiggles. Recovered tiers, top-decile funded RPG books only.*\
*Source: Wayback-recovered reward tiers, CPI-adjusted.*

Put together, the pieces stop fighting each other. Any *given* tier held its real value, yet the *typical project* still raised less — because campaigns now spread their backers across more, and cheaper, tiers (a $1–15 PDF or entry pledge sitting under the hardback), and because more, smaller projects launch every year. The same hardback now sells into a much broader base of cheap-tier backers, which drags the *average* outlay down even as its own price holds. One honest wrinkle: at the **population** level the average RPG product really is cheaper now — but only because cheap formats like zines and PDF-only releases proliferated, which is composition again, not discounting. RPG products didn't get cheaper; the *mix* did. Creators have set their asks to match — the goals they choose have fallen even faster in real terms, which I come back to below.

The hobby's crowdfunding has grown by getting *broader and cheaper at the bottom*: more projects, more backers, each one a smaller, more PDF-and-zine-shaped bet — but not because the books themselves cost less. Creators have set their asks to match — the goals they choose have fallen even faster in real terms, which I come back to below.
...
The project attributes still matter, just less. Holding other things equal: an actual RPG is more likely to fund than a board or card game; a "5E-compatible" or D&D/Pathfinder label helps further; US-based projects do a bit better.[^rpgonly] And there's the perennial Kickstarter finding — **modest goals fund more reliably.** Each tenfold increase in the goal cuts the odds of funding by roughly two-thirds.
...
I *wouldn't* tell you that any of these are guaranteed levers. Almost everything here is a correlation drawn from observational data, with all the usual hazards: creators choose their goals strategically, Kickstarter chooses who gets staff-picked, my RPG classifier is imperfect,[^classifier] and the one result that is in the neighborhood of a causal effect is about a niche February program for zines.
